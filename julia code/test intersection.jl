...
function INTERSECTION_HH(P, Q, n_samples, solver)
    ...
    if !flag
        ...
        try
            ...
            Ints = Intersection_HH(P, Q, n_samples, solver)
            ...
            if n==2 || n==3
                ...
                f = proj_plot(f, Ints, false, "blue")
                f = poly_plot(f, polyhedron(vrep(Ints')), "cyan")
...
function INTERSECTION_HV(P, Q, n_samples, solver)
    ...
    if !flag
        ...
        try
            print("  Generating projections...\n")
            Ints = Intersection_HV(P, Q, n_samples, solver)
            print("  Projections computed")
            #=
            if n==2 || n==3
                print(", plotting the results...")
...
function INTERSECTION_VV(P, Q, n_samples, solver)
    ...
    if !flag
        ...
        try
            print("  Generating projections...\n")
            Ints = Intersection_VV(P, Q, n_samples, solver)
            print("  Projections computed...\n")
            #=
            if n==2 || n==3
                print(", plotting the results...")
...
#INTERSECTION_HH(50, 3, 500, solver)
#INTERSECTION_HV(50, 100, 3, 500, solver)
#INTERSECTION_VV(100, 100, 3, 500, solver)
...
for n in [150,250]
    ...
    for k1 in 1:10
        for k2 in 1:5
            ...
            name_Q = "H_Rep/Ab_$(l)x$(n)_$k1.csv"
            ...
            t = @timed INTERSECTION_HH(P, Q, 1000, solver)
    ...
    name = "C:/Users/david/University/TESI/test samples/results/Intersection_HH - 300/Intersection_HH_$(l)x$(n).txt"
    writedlm(name, T, ";")
    #=
    avg = sum(T)/100
    var = sum((T.-avg).^2)/100
